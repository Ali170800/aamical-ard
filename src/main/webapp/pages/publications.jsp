    ...
    <% if (publications != null && !publications.isEmpty()) { %>
        ...
        <div class="bg-white rounded-3xl shadow-lg mb-8 sm:mb-10 overflow-hidden">
            ...
            <div class="p-4 sm:p-6">
                ...
                <!-- DESCRIPTION -->
                <p class="text-gray-700 text-base sm:text-lg mb-4 break-words">
                ...
                <div class="flex flex-col sm:flex-row gap-4 sm:gap-6 border-t pt-4">
                    ...
                    <button onclick="liker('<%= p.getId() %>')"
                            class="font-bold text-red-500 text-sm sm:text-base text-left sm:text-center">
                    ...
                    <button onclick="document.getElementById('com-<%= p.getId() %>').classList.toggle('hidden')"
                            class="font-bold text-blue-600 text-sm sm:text-base text-left sm:text-center">
                ...
                <div id="com-<%= p.getId() %>" class="hidden mt-6 bg-gray-50 p-4 rounded-2xl">
                    ...
                    <form action="<%= request.getContextPath() %>/etudiant/commenter-publication"
                        ...
                        <textarea name="commentaire" required
                                  ...
                                  class="w-full p-3 border rounded-xl text-sm sm:text-base"
                                  rows="2"></textarea>

                        <button type="submit"
                                class="mt-2 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm">
                            Publier
                        </button>
