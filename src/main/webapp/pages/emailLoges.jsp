...
<html>
<head>
    <title>📧 Envoyer un e‑mail aux étudiants logés</title>
    <style>
        body {
...
<div class="container">
    ...
    <form method="post" action="${pageContext.request.contextPath}/email/loges">
        ...
        <button type="submit" class="btn">📤 Envoyer aux étudiants logés</button>
    </form>
