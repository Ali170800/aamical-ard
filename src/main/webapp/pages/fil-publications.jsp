            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between border-t pt-4">
                    ...
                    <div class="text-sm text-gray-500">
                        ...
                        Publication du : <%= publication.getDatePublication() %>
                    </div>
                ...
                <div class="flex items-center gap-6 mt-6">
                    ...
                    <button
                            type="button"
                            onclick="ajouterCommentaire(<%= publication.getId() %>)"
                ...
                <div id="zone-commentaires-<%= publication.getId() %>"
...
<script>
    ...
    function likerPublication(pubId) {
        ...
        btn.innerHTML =
            '<i class="fas fa-thumbs-up"></i><span>Liké</span>';
    ...
    function ajouterCommentaire(pubId) {
        ...
        const zone =
            document.getElementById('zone-commentaires-' + pubId);

        const commentaire =
            document.createElement('div');

        commentaire.className =
            "bg-gray-100 p-3 rounded-xl text-sm text-gray-700";

        commentaire.innerText = texte;

        zone.appendChild(commentaire);
        ...
        fetch('<%= request.getContextPath() %>/etudiant/commenter-publication', {
            ...
            body:
                'publicationId=' + pubId +
                '&commentaire=' + encodeURIComponent(texte)
        })
