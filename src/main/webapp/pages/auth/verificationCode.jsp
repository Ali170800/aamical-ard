...
<div class="w-full max-w-md sm:max-w-lg">
    ...
    <div class="glass rounded-3xl shadow-2xl overflow-hidden">
        ...
        <!-- Header -->
        <div class="bg-indigo-700 text-white text-center p-6 sm:p-8">
        ...
        <div class="p-6 sm:p-8">
            ...
            <form method="post"
                ...
                <div class="mb-6">
                    ...
                    <label class="block text-slate-700 font-medium mb-2 text-sm sm:text-base">
                        Code de validation
                    </label>
                    ...
                    <input type="text"
                           ...
                           required
                           class="w-full px-4 py-3 sm:py-4 border border-slate-300 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-300 text-center text-xl sm:text-2xl tracking-[6px] sm:tracking-[8px] font-bold">

                </div>

                <!-- Bouton -->
                <button type="submit"
                        class="w-full bg-indigo-600 hover:bg-indigo-700 transition duration-300 text-white font-bold py-3 sm:py-4 rounded-2xl shadow-lg text-base sm:text-lg">
            ...
            <div class="text-center mt-6">
                ...
                <a href="${pageContext.request.contextPath}/pages/auth/motDePasseOublie.jsp"
                   class="text-indigo-600 hover:text-indigo-800 text-sm sm:text-base font-semibold">
