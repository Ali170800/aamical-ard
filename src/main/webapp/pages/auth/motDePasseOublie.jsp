        ...
        <form method="post"
            ...
            <div class="mb-6">
                ...
                <input type="email"
                       ...
                       required
                       class="w-full px-4 py-3 border border-slate-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm sm:text-base">

            </div>

            <!-- BOUTON -->
            <button type="submit"
                    class="w-full bg-indigo-600 hover:bg-indigo-700 transition duration-300 text-white font-bold py-3 sm:py-4 rounded-2xl shadow-lg text-sm sm:text-base">
