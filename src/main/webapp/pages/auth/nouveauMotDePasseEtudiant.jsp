        ...
        <form method="post"
            ...
            <div class="mb-6">
                ...
                <input type="password"
                       ...
                       required
                       minlength="6"
                       class="input-style w-full px-5 py-4 border border-slate-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
            ...
            <!-- BOUTON -->
            <button type="submit"
                    class="btn-style w-full bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white font-bold py-4 rounded-2xl shadow-xl text-lg">
