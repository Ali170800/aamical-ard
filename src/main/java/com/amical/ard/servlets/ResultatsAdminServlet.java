...
public class ResultatsAdminServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (idStr == null) { response.sendRedirect(request.getContextPath() + "/admin/tableau-bord"); return; }
        ...
        boolean estTermine = maintenant.isAfter(election.getDateFin());
