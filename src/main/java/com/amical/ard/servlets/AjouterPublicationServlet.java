    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            ...
            try {
                ...
                auteurId = (Integer) admin.getClass().getMethod("getId").invoke(admin);
                nom = (String) admin.getClass().getMethod("getNom").invoke(admin);
                prenom = (String) admin.getClass().getMethod("getPrenom").invoke(admin);
                role = (String) admin.getClass().getMethod("getRole").invoke(admin);
            ...
            String nomFichier = Paths.get(imagePart.getSubmittedFileName()).getFileName().toString();
            ...
            imagePart.write(uploadPath + File.separator + nomFichier);
