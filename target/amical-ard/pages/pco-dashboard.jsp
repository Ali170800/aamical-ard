...
<aside class="w-64 bg-gray-900 text-white flex flex-col h-screen fixed top-0 left-0 shadow-xl z-10">
    ...
    <nav class="flex-grow py-4 px-3 space-y-1 overflow-y-auto">
        ...
        <!-- 🔥 BOUTON IMPORTANT -->
        <a href="<%= request.getContextPath() %>/pco-dashboard"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-home"></i> Tableau de bord
        </a>

        <!-- 🔥 COMMUNAUTÉ -->
        <div class="px-3 py-2 text-xs text-gray-400 uppercase mt-2">
            Communauté
        </div>

        <a href="<%= request.getContextPath() %>/pages/publication/ajouterPublication.jsp"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-image"></i> Ajouter publication
        </a>

        <a href="<%= request.getContextPath() %>/liste-publications"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-newspaper"></i> Voir publications
        </a>
        ...
        <a href="<%= request.getContextPath() %>/caravane/creer"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-route"></i> Créer une caravane
        </a>

        <a href="<%= request.getContextPath() %>/caravane/lister"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-list"></i> Liste des caravanes
        </a>
        ...
        <!-- 🔥 GESTION PDF -->
        <div class="px-3 py-2 mt-6 text-xs text-gray-400 uppercase">
            Documents PDF
        </div>

        <a href="<%= request.getContextPath() %>/fichiers/liste"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-file-pdf"></i> Gestion des PDF
        </a>

        <a href="<%= request.getContextPath() %>/pages/fichiers/uploadFichier.jsp"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-upload"></i> Ajouter un PDF
        </a>
        ...
        <a href="<%= request.getContextPath() %>/email/loges"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-envelope"></i> Étudiants logés
        </a>

        <a href="<%= request.getContextPath() %>/emails/bureau"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-envelope-open"></i> Bureau
        </a>

        <a href="<%= request.getContextPath() %>/emails/etudiants"
           class="menu-item flex items-center gap-3 px-4 py-3 hover:bg-gray-800 rounded-xl">
            <i class="fas fa-paper-plane"></i> Tous les étudiants
        </a>
    </nav>
    ...
    <div class="p-4 border-t border-gray-800">
        <a href="<%= request.getContextPath() %>/LogoutServlet"
           class="flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-900/30 rounded-xl">
...
<main class="flex-1 ml-64 p-10 bg-gray-50 min-h-screen">
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <div>
                <h1 class="text-4xl font-black text-gray-800">
                    Espace Commission Organisation (PCO)
                </h1>
        ...
        <p class="text-gray-600 mb-10">
            Vous gérez les caravanes, participants et communications.
        </p>
      ...
      <a href="<%= request.getContextPath() %>/upload/ajouterPublication.jsp"
               class="hover-card bg-white p-8 rounded-3xl shadow text-center">

                <i class="fas fa-image text-4xl text-pink-600 mb-4"></i>
            ...
            <a href="<%= request.getContextPath() %>/caravane/creer"
               class="hover-card bg-white p-8 rounded-3xl shadow text-center">
                ...
                <i class="fas fa-route text-4xl text-indigo-600 mb-4"></i>
            ...
            <a href="<%= request.getContextPath() %>/caravane/lister"
               class="hover-card bg-white p-8 rounded-3xl shadow text-center">
                ...
                <i class="fas fa-list text-4xl text-indigo-600 mb-4"></i>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex justify-between">
                                   ...
                                   <span class="text-xs text-gray-500">
                                       ${log.dateAction.toString().replace('T', ' ').substring(0,16)}
                                   </span>
